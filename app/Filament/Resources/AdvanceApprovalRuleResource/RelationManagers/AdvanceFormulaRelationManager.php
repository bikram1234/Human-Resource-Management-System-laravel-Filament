...
namespace App\Filament\Resources\AdvanceApprovalRuleResource\RelationManagers;
...
use App\Models\AdvanceFormula;

class AdvanceFormulaRelationManager extends RelationManager
{
    protected static string $relationship = 'AdvanceFormulas';
    ...
    public function onSave($record, array $data)
    {
        ...
        $existingFormula = AdvanceFormula::where('approval_rule_id', $data['approval_rule_id'])->first();
