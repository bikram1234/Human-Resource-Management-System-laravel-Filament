...
class LoanAdvanceFormulaRelationManager extends RelationManager
{
    protected static string $relationship = 'LoanAdvanceFormula';
    ...
    public function onSave($record, array $data)
    {
        ...
        $existingFormula = LoanAdvanceFormula::where('approval_rule_id', $data['approval_rule_id'])->first();
