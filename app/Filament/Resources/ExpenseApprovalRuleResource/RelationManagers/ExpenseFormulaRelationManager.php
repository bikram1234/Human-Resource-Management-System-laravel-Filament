...
namespace App\Filament\Resources\ExpenseApprovalRuleResource\RelationManagers;
...
{
    protected static string $relationship = 'ExpenseFormulas';
    ...
    public function onSave($record, array $data)
    {
        ...
        $existingFormula = ExpenseFormula::where('approval_rule_id', $data['approval_rule_id'])->first();
