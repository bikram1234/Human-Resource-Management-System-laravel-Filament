...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('mas_employees', function (Blueprint $table) {
            ...
            $table->uuid("grade_step_id")->nullable();
            $table->uuid('designation_id')->nullable();
            $table->foreign("designation_id")->on("mas_designations")->references("id")->onDelete('set null');
            ...
            $table->foreign("grade_id")->on("mas_grades")->references("id")->onDelete('set null');
            $table->foreign("grade_step_id")->on("mas_grade_steps")->references("id")->onDelete('set null');
