...
return new class extends Migration
{
    ...
    {
        Schema::create('loan_advance_formulas', function (Blueprint $table) {
            ...
            $table->foreign("approval_rule_id")->references("id")->on("loan_advance_approval_rules")->onDelete('RESTRICT')->onUpdate('CASCADE');
    ...
    {
        Schema::dropIfExists('loan_advance_formulas');
    }
};
