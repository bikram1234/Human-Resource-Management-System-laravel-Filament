...
return new class extends Migration
{
    ...
    {
        Schema::create('d_s_a_approvals', function (Blueprint $table) {
            $table->uuid('id')->primary();
            $table->uuid('applied_expense_id');
            $table->foreign("applied_expense_id")->references("id")->on("d_s_a_settlements")->onDelete('RESTRICT')->onUpdate('CASCADE');            
    ...
    {
        Schema::dropIfExists('d_s_a_approvals');
    }
};
