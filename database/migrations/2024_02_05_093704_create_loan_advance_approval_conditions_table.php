...
return new class extends Migration
{
    ...
    {
        Schema::create('loan_advance_approval_conditions', function (Blueprint $table) {
            ...
            $table->foreign('approval_rule_id')->references('id')->on('loan_advance_approval_rules')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('loan_advance_approval_conditions');
    }
};
