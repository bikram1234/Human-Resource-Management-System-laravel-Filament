...
return new class extends Migration
{
    ...
    {
        Schema::create('advance_formulas', function (Blueprint $table) {
            ...
            $table->foreign("approval_rule_id")->references("id")->on("advance_approval_rules")->onDelete('RESTRICT')->onUpdate('CASCADE');
    ...
    {
        Schema::dropIfExists('advance_formulas');
    }
};
