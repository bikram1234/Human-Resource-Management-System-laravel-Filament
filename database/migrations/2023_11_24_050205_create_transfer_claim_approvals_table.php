...
return new class extends Migration
{
    ...
    {
        Schema::create('transfer_claim_approvals', function (Blueprint $table) {
            $table->uuid('id')->primary();
            $table->uuid('applied_expense_id');
            $table->foreign("applied_expense_id")->references("id")->on("transfer_claims")->onDelete('RESTRICT')->onUpdate('CASCADE');            
    ...
    {
        Schema::dropIfExists('transfer_claim_approvals');
    }
};
