...
return new class extends Migration
{
    ...
    {
        Schema::create('expense_formulas', function (Blueprint $table) {
            ...
            $table->foreign("approval_rule_id")->references("id")->on("expense_approval_rules")->onDelete('RESTRICT')->onUpdate('CASCADE');
    ...
    {
        Schema::dropIfExists('expense_formulas');
    }
};
